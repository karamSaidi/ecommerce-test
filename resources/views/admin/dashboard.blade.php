                ...
                <div class="card-body">
                    <div class="media d-flex">
                        <div class="media-body text-left">
                            ...
                            <h6>{{__('admin/dashboard.total_order')}}</h6>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="media d-flex">
                        <div class="media-body text-left">
                            ...
                            <h6>{{__('admin/dashboard.total_sale')}}</h6>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="media d-flex">
                        <div class="media-body text-left">
                            ...
                            <h6>{{__('admin/dashboard.total_purchase')}}</h6>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    <div class="media d-flex">
                        <div class="media-body text-left">
                            ...
                            <h6>{{__('admin/dashboard.total_customers')}}</h6>
                        </div>
                        <div>
...
<div class="row match-height">
    <div class="col-xl-5 col-12" id="ecommerceChartView">
        <div class="card card-shadow">
            <div class="card-header card-header-transparent py-20">
                <div class="btn-group dropdown">
                    <a href="#" class="text-body dropdown-toggle blue-grey-700" data-toggle="dropdown">Order
                        statistic</a>
    ...
    <div class="col-xl-7 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{__('admin/dashboard.last_order')}}</h4>
                ...
                <div id="new-orders" class="media-list position-relative">
                    <div class="table-responsive">
                        <table id="new-orders-table" class="table table-hover table-xl mb-0">
                            <thead>
                                <tr>
                                    <th class="border-top-0">{{__('admin/dashboard.order_no')}}</th>
                                    <th class="border-top-0">{{__('admin/dashboard.customer_name')}}</th>
                                    <th class="border-top-0">{{__('admin/dashboard.order_price')}}</th>
                                    <th class="border-top-0">{{__('admin/dashboard.order_status')}}</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-truncate">10000011</td>
                                    <td class="text-truncate p-1">Hassan ali</td>
                                    <td class="text-truncate">$899</td>
                                    <td class="text-truncate">processing</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
