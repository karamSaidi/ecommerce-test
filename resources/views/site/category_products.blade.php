                            ...
                            <div class="item  col-lg-4 col-md-6 col-xs-12 text-center no-padding">
                                <div class="product-miniature js-product-miniature item-one" data-id-product="1"
                                    ...
                                    <div class="thumbnail-container">
                                        ...
                                        <a href="http://demo.bestprestashoptheme.com/savemart/en/smartphone-tablet/1-40-hummingbird-printed-t-shirt.html#/1-size-s/6-color-taupe"
                                    ...
                                    <div class="product-description">
                                        <div class="product-groups">
                                            ...
                                            <div class="category-title"><a
                                                    href="{{ route('category.products', $category->slug) }}">{{ $category->name }}</a></div>
                                            ...
                                            <div class="product-title" itemprop="name"><a
                                                    href="http://demo.bestprestashoptheme.com/savemart/en/smartphone-tablet/1-40-hummingbird-printed-t-shirt.html#/1-size-s/6-color-taupe">
                                                    {{ $product->name }}</a></div>
                    ...
                    <nav class="pagination row justify-content-around">
                        ...
                        <div class="col col-xs-12 col-lg-6 col-md-12">
                            ...
                            <ul class="page-list">
                                <li class="current">
                                    <a rel="nofollow"
                                        href="http://demo.bestprestashoptheme.com/savemart/en/3-computer-networking"
