                        ...
                        <div class="box-content block_content">
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    ...
                                    <li class="item  {{ $category->childs? 'parent': '' }}">
                                        <a href="{{ route('category.products', $category->slug) }}"
                                            title="{{ $category->name }}">
                                            <i class="hasicon nov-icon"
                                                style="background:url('{{ $category->image_url }}') no-repeat scroll center center;"></i>
                                            {{ $category->name }}
                                        </a>
                                        ...
                                        <div class="dropdown-menu" style="width:222px">
                                            <ul>
                                                @foreach ($category->childs as $firstChild)
                                                <li class="item  {{ $firstChild->childs? 'parent': '' }}">
                                                    <a href="{{ route('category.products', $firstChild->slug) }}"
                                                        title="{{$firstChild->name}}">
                                                        {{$firstChild->name}}
                                                    </a>
                                                    @isset($firstChild->childs)
                                                    <span class="show-sub fa-active-sub"></span>
                                                    <div class="dropdown-menu">
                                                        <ul>
                                                            @foreach ($firstChild->childs as $secondChild)
                                                            <li class="item ">
                                                                <a href="{{ route('category.products', $secondChild->slug) }}"
                                                                    title="{{ $secondChild->name }}">{{ $secondChild->name }}</a>
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
